...
class ApiService {
  ...
  Future<Map<String, dynamic>> post(String url, {Map<String, dynamic>? body}) async {
    final res = await http.post(Uri.parse(url), headers: await _headers(), body: body != null ? jsonEncode(body) : null);
    return _handle(res);
  }

  Future<Map<String, dynamic>> put(String url, {Map<String, dynamic>? body}) async {
    final res = await http.put(Uri.parse(url), headers: await _headers(), body: body != null ? jsonEncode(body) : null);
    return _handle(res);
  }
